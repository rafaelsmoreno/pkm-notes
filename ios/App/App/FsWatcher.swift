        ...
        if let enumerator = FileManager.default.enumerator(
            ...
            for case let fileURL as URL in enumerator {
                ...
                if isDirectory {
                    ...
                    if fileURL.path.hasSuffix("/logseq/bak") || fileURL.path.hasSuffix("/logseq/version-files") || name == ".recycle" || name.hasPrefix(".") || name == "node_modules" || name == ".obsidian" || name == ".trash" {
